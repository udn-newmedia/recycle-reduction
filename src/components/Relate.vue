    ...
    <div>
      ...
      <div class="row">
        <div class="col-sm-6 col-md-3">
          <a :href="setProps('href1')" target="_blank" @click="relateClick(setProps('text1'))" :title="setProps('text1')">
            <img :src="setProps('img1')" :alt="setProps('text1')"/>
            <p>{{setProps('text1')}}</p>
          </a>
        </div>
        <div class="col-sm-6 col-md-3">
          <a :href="setProps('href2')" target="_blank" @click="relateClick(setProps('text2'))" :title="setProps('text2')">
            <img :src="setProps('img2')" :alt="setProps('text2')"/>
            <p>{{setProps('text2')}}</p>
          </a>
        </div>
        <div class="col-sm-6 col-md-3">
          <a :href="setProps('href3')" target="_blank" @click="relateClick(setProps('text3'))" :title="setProps('text3')">
            <img :src="setProps('img3')" :alt="setProps('text3')"/>
            <p>{{setProps('text3')}}</p>
          </a>
        </div>
        <div class="col-sm-6 col-md-3">
          <a :href="setProps('href4')" target="_blank" @click="relateClick(setProps('text4'))" :title="setProps('text4')">
            <img :src="setProps('img4')" :alt="setProps('text4')"/>
            <p>{{setProps('text4')}}</p>
          </a>
        </div>
      </div>
